...
function SingleGame({name, description, ondelete, id, onUpdateDes}){
  ...
  function handleDeleteClick() {
    ...
    <div className="flex justify-center">
        <div className="block p-6 shadow-lg bg-gray-200 w-30 h-50 resize- mx-12 my-10 ">
             ...
             <p className="text-gray-700 text-base mb-4 " >{description}</p>)}
              ...
              <Link to={`/games/${id}`} className=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Reviews</Link>
