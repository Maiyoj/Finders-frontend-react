function Footer(){
   return(
     <>
     <footer className="text-center lg:text-left bg-[#1f2937] text-white mt-2">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Gaming Mice</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-white">Gaming Controllers</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-white">Game Headsets</a>
        </p>
        <p>
          <a href="#!" className="text-white">Gaming Keyboards</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Games</a>
        </p>
        <p>
  ...
  <div className="text-center p-6 white bg-[#1f2937]">
    <span>© 2021 Copyright:</span>
    <a className="text-white" href="https://tailwind-elements.com/">Game Finders</a>
  </div>
</footer>
